...
#r = #xegpu.layout<inst_data = [8, 16]>
gpu.module @kernel {
  gpu.func @transpose(%a: memref<64x128xf32>, %b: memref<128x64xf32>) {
    %c16 = arith.constant 16 : index
    %c32 = arith.constant 32 : index
    %block_id_x = gpu.block_id x
    %block_id_y = gpu.block_id y
    ...
    %0 = xegpu.create_nd_tdesc %a[%m, %n] : memref<64x128xf32> -> !xegpu.tensor_desc<16x32xf32, #l>
    %1 = xegpu.load_nd %0: !xegpu.tensor_desc<16x32xf32, #l> -> vector<16x32xf32>

    //CHECK-COUNT-4: vector.transpose {{.*}}, [1, 0] : vector<16x8xf32> to vector<8x16xf32>
    %2 = vector.transpose %1, [1, 0] {layout_result_0 = #r}: vector<16x32xf32> to vector<32x16xf32>
    %3 = xegpu.create_nd_tdesc %b[%n, %m] : memref<128x64xf32> -> !xegpu.tensor_desc<32x16xf32, #r>

    //CHECK-COUNT-4: xegpu.store_nd {{.*}} : vector<8x16xf32>, !xegpu.tensor_desc<8x16xf32>
    xegpu.store_nd %2, %3: vector<32x16xf32>, !xegpu.tensor_desc<32x16xf32, #r>
    gpu.return
  }
}
...
gpu.module @kernel  attributes {spirv.target_env = #spirv.target_env<#spirv.vce<v1.4, [Addresses, Float16Buffer, Int64, Int16, Int8, Kernel, Linkage, Vector16, GenericPointer, Groups, Float16, Float64, AtomicFloat32AddEXT, ExpectAssumeKHR, SubgroupDispatch, VectorComputeINTEL, VectorAnyINTEL], [SPV_EXT_shader_atomic_float_add, SPV_KHR_expect_assume, SPV_INTEL_vector_compute]>, api=OpenCL, #spirv.resource_limits<>>} {
  // the kernel is a 32x32 block reduction. each thread is assigned with a 32x32 block, and do reduction along dim-0 independently.
  gpu.func @reduce_dim_0(%a: memref<32x512xf32>, %b: memref<512xf32>)  kernel attributes {VectorComputeFunctionINTEL, spirv.entry_point_abi = #spirv.entry_point_abi<>} {
    ...
    %m = arith.muli %block_id_x, %c32 : index
    %n = arith.muli %block_id_y, %c32 : index
    %0 = xegpu.create_nd_tdesc %a[%m, %n] : memref<32x512xf32> -> !xegpu.tensor_desc<32x32xf32, #l>
    %1 = xegpu.load_nd %0: !xegpu.tensor_desc<32x32xf32, #l> -> vector<32x32xf32>
    %2 = vector.multi_reduction <add>, %1, %acc {layout_result_0 = #r} [1]: vector<32x32xf32> to vector<32xf32>
...
#b = #xegpu.layout<inst_data = [16, 16]>
gpu.module @kernel {
  gpu.func @broadcast(%a: memref<512xf32>, %b: memref<32x512xf32>) {
    %c32 = arith.constant 32 : index
    %block_id_x = gpu.block_id x
    %m = arith.muli %block_id_x, %c32 : index
    %0 = xegpu.create_nd_tdesc %a[%m] : memref<512xf32> -> !xegpu.tensor_desc<32xf32, #l>
    //CHECK: [[d1:%.+]] = xegpu.load_nd %1  : !xegpu.tensor_desc<16xf32> -> vector<16xf32>
    //CHECK: [[d2:%.+]] = xegpu.load_nd %3  : !xegpu.tensor_desc<16xf32> -> vector<16xf32>
    %1 = xegpu.load_nd %0: !xegpu.tensor_desc<32xf32, #l> -> vector<32xf32>

    //CHECK: [[b1:%.+]] = vector.broadcast [[d1]] : vector<16xf32> to vector<16x16xf32>
    //CHECK: [[b2:%.+]] = vector.broadcast [[d2]] : vector<16xf32> to vector<16x16xf32>
    //CHECK: [[b3:%.+]] = vector.broadcast [[d1]] : vector<16xf32> to vector<16x16xf32>
    //CHECK: [[b4:%.+]] = vector.broadcast [[d2]] : vector<16xf32> to vector<16x16xf32>
    %2 = vector.broadcast %1 {layout_result_0 = #b} : vector<32xf32> to vector<32x32xf32>
    %3 = xegpu.create_nd_tdesc %b[0, %m] : memref<32x512xf32> -> !xegpu.tensor_desc<32x32xf32, #b>

    //CHECK: xegpu.store_nd [[b1]], {{.*}} : vector<16x16xf32>, !xegpu.tensor_desc<16x16xf32>
    //CHECK: xegpu.store_nd [[b2]], {{.*}} : vector<16x16xf32>, !xegpu.tensor_desc<16x16xf32>
    //CHECK: xegpu.store_nd [[b3]], {{.*}} : vector<16x16xf32>, !xegpu.tensor_desc<16x16xf32>
    //CHECK: xegpu.store_nd [[b4]], {{.*}} : vector<16x16xf32>, !xegpu.tensor_desc<16x16xf32>
    xegpu.store_nd %2, %3: vector<32x32xf32>, !xegpu.tensor_desc<32x32xf32, #b>
    gpu.return
  }
}
